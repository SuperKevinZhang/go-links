...
/*                              var gameid=value.GameId;
                              ...
                              output+= "<li><a class='myGame_a' onclick=\"om.changeHashPage('gameDetail.html',{gameid:'"+value.GameId+"',id:'"+value.Id+"',fromgame:'roundgame'})\" href='#' id='a_game'>";
                              output+=" <img src='img/game_96.png' class='list_image'>"
                              output+="<h6  class='detail_name'>执黑:"+value.BlackPlayerName+"</h6>";
                              output+="<h6  class='detail_name'>执白:"+value.WhitePlayerName+"</h5>";
